"""
실행하면 insert_testuser.sql 파일을 생성합니다.
사용법: python generate_insert_testuser.py
"""
import bcrypt
import os
...
sql = f"""-- 일반 사용자 삽입 (비밀번호: bcrypt 해시)
...
out_path = os.path.join(os.path.dirname(__file__), 'insert_testuser.sql')
